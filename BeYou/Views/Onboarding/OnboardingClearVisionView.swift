...
struct OnboardingClearVisionView: View {
    ...
    private let options = [
        ...
        (id: "working-on-it", label: "I'm working on it"),
        (id: "one-day", label: "I take it one day at a time"),
        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                ScrollView {
                    VStack(spacing: 0) {
                        VStack(spacing: 10) {
                            Text("Do you have a clear vision of the life you want?")
                ...
                Button(action: {
                    if let selection = selected {
                        appState.onboardingData.clearVision = selection
                        onNext()
                    }
                }) {
                    Text("Continue")
