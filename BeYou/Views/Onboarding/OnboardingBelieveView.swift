...
struct OnboardingBelieveView: View {
    ...
    private let options = [
        ...
        (id: "curious", label: "Not sure, but I'm curious"),
        (id: "not-my-thing", label: "It's not my thing")
    ]
        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                ScrollView {
                    VStack(spacing: 0) {
                        VStack(spacing: 10) {
                            Text("Do you believe in the power of manifestation?")
                ...
                Button(action: {
                    if let selection = selected {
                        appState.onboardingData.believeManifestation = selection
                        onNext()
                    }
                }) {
                    Text("Continue")
